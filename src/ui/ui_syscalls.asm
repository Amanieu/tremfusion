...
equ trap_CrosshairPlayer              -81
equ trap_LastAttacker                 -82
equ trap_Parse_AddGlobalDefine        -83
equ trap_Parse_LoadSource             -84
equ trap_Parse_FreeSource             -85
equ trap_Parse_ReadToken              -86
equ trap_Parse_SourceFileAndLine      -87
