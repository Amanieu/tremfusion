...
skill 1
{
	CHARACTERISTIC_NAME							"Capt. Pain"
	CHARACTERISTIC_GENDER						"Male"
	CHARACTERISTIC_ATTACK_SKILL					0.250
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/capt_pain_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/capt_pain_t.c"
	CHARACTERISTIC_CHAT_NAME					"capt_pain"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/capt_pain_i.c"
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER		0.700
	CHARACTERISTIC_AIM_ACCURACY_RIFLE			0.500
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN	0.600
	CHARACTERISTIC_AIM_ACCURACY_LASGUN	0.500
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		0.700
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		0.450
	CHARACTERISTIC_AIM_ACCURACY_PULSE			0.400
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER			0.800
	CHARACTERISTIC_AIM_SKILL_LASGUN		0.500
	CHARACTERISTIC_AIM_SKILL_PULSE	0.500
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER			0.500
	CHARACTERISTIC_AIM_SKILL_LUCIFER				0.500
...
skill 4
{
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER		0.900
	CHARACTERISTIC_AIM_ACCURACY_RIFLE			0.900
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN	0.900
	CHARACTERISTIC_AIM_ACCURACY_LASGUN	0.900
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		0.900
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		0.900
	CHARACTERISTIC_AIM_ACCURACY_PULSE			0.900
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER			0.900
	CHARACTERISTIC_AIM_SKILL_LASGUN		0.900
	CHARACTERISTIC_AIM_SKILL_PULSE	0.900
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER			0.900
	CHARACTERISTIC_AIM_SKILL_LUCIFER				0.900
...
skill 5
{
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER		0.900
	CHARACTERISTIC_AIM_ACCURACY_RIFLE			1.000
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN	1.000
	CHARACTERISTIC_AIM_ACCURACY_LASGUN	1.000
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		1.000
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		1.000
	CHARACTERISTIC_AIM_ACCURACY_PULSE			1.000
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER			1.000
	CHARACTERISTIC_AIM_SKILL_LASGUN		1.000
	CHARACTERISTIC_AIM_SKILL_PULSE	1.000
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER			1.000
	CHARACTERISTIC_AIM_SKILL_LUCIFER				1.000
