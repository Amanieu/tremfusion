...
skill 1
{
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER			0.3
	CHARACTERISTIC_AIM_ACCURACY_RIFLE			0.3
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			0.3
	CHARACTERISTIC_AIM_ACCURACY_LASGUN			0.3
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		0.3
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		0.3
	CHARACTERISTIC_AIM_ACCURACY_PULSE			0.3
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER			0.3
	CHARACTERISTIC_AIM_SKILL_LASGUN				0.3
	CHARACTERISTIC_AIM_SKILL_PULSE				0.3
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER			0.3
	CHARACTERISTIC_AIM_SKILL_LUCIFER			0.3
...
skill 4
{
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER		0.5
	CHARACTERISTIC_AIM_ACCURACY_RIFLE			0.75
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN	0.75
	CHARACTERISTIC_AIM_ACCURACY_LASGUN	0.75
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		0.75
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		0.75
	CHARACTERISTIC_AIM_ACCURACY_PULSE			0.75
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER			0.75
	CHARACTERISTIC_AIM_SKILL_LASGUN		0.75
	CHARACTERISTIC_AIM_SKILL_PULSE	0.75
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER			0.75
	CHARACTERISTIC_AIM_SKILL_LUCIFER				0.75
...
skill 5
{
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER            1.0
	CHARACTERISTIC_AIM_ACCURACY_RIFLE                       1.0
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN     1.0
	CHARACTERISTIC_AIM_ACCURACY_LASGUN      1.0
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER          1.0
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN            1.0
	CHARACTERISTIC_AIM_ACCURACY_PULSE                       1.0
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER                     1.0
	CHARACTERISTIC_AIM_SKILL_LASGUN         1.0
	CHARACTERISTIC_AIM_SKILL_PULSE  1.0
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER                     1.0
	CHARACTERISTIC_AIM_SKILL_LUCIFER                                1.0
