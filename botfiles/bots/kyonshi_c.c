...
skill 4
{
	...
	CHARACTERISTIC_AIM_ACCURACY_BLASTER			0.9
	CHARACTERISTIC_AIM_ACCURACY_RIFLE			0.9
	CHARACTERISTIC_AIM_ACCURACY_SHOTGUN			0.9
	CHARACTERISTIC_AIM_ACCURACY_LASGUN			0.9
	CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		0.9
	CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		0.9
	CHARACTERISTIC_AIM_ACCURACY_PULSE			0.9
	CHARACTERISTIC_AIM_ACCURACY_LUCIFER			0.9
	CHARACTERISTIC_AIM_SKILL_LASGUN				0.9
	CHARACTERISTIC_AIM_SKILL_PULSE				0.9
	CHARACTERISTIC_AIM_SKILL_MASSDRIVER			0.9
	CHARACTERISTIC_AIM_SKILL_LUCIFER			0.9
