...
#define CHARACTERISTIC_AIM_ACCURACY_RIFLE			9	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_SHOTGUN	10	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_LASGUN	11	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_MASSDRIVER		12
#define CHARACTERISTIC_AIM_ACCURACY_CHAINGUN		13	//float [0, 1]
#define CHARACTERISTIC_AIM_ACCURACY_PULSE			14
#define CHARACTERISTIC_AIM_ACCURACY_LUCIFER			15	//float [0, 1]
//skill when aiming
...
#define CHARACTERISTIC_AIM_SKILL_PULSE	18	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_MASSDRIVER			19	//float [0, 1]
#define CHARACTERISTIC_AIM_SKILL_LUCIFER				20	//float [0, 1]
//========================================================
//chat
//========================================================
//file with chats
